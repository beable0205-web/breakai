export default function PrivacyPolicy() {
    return (
        <div className="max-w-4xl mx-auto px-6 py-20 text-slate-300 font-sans leading-relaxed">
            <h1 className="text-4xl font-bold text-white mb-8 border-b border-[#333] pb-4">Privacy Policy</h1>
            ...
            <div className="space-y-8">
                <section>
                    ...
                    <p>Welcome to Breakout AI. We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you about how we look after your personal data when you visit our website (regardless of where you visit it from) and tell you about your privacy rights and how the law protects you.</p>
                </section>

                <section>
                    <h2 className="text-2xl font-semibold text-emerald-400 mb-4">2. The Data We Collect About You</h2>
                ...
                <section>
                    <h2 className="text-2xl font-semibold text-emerald-400 mb-4">3. How We Use Your Personal Data</h2>
