    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4">
            <div className="bg-[#111] border border-[#333] rounded-2xl w-full max-w-md shadow-2xl relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#00FF41] to-emerald-600"></div>
                ...
                <div className="p-8">
                    <div className="mb-8 text-center">
                        ...
                        <p className="text-zinc-500 text-sm font-medium">Enter your credentials to access premium features.</p>
                    </div>
