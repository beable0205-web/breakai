    ...
    useEffect(() => {
        ...
        const checkAuth = async () => {
            ...
            if (email && email.toLowerCase() === "beable9489@gmail.com") {
                ...
                // Redirect non-admins after a short delay, but only if they are actually logged in
                if (email) {
                    setTimeout(() => {
                        router.push("/");
                ...
                {detectedEmail === "None" ? (
                    <div className="mt-8 flex flex-col items-center gap-4">
                        ...
                        <p className="text-zinc-600 text-xs text-center max-w-sm">
                            Since public authentication is hidden during the AdSense review, use this direct login to access your admin dashboard.
                        </p>
                    </div>
                ) : (
