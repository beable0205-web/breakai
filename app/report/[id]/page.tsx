...
export default async function ReportPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="max-w-4xl mx-auto mt-10 p-6 space-y-8 mb-20">
            ...
            <section className="mt-16 bg-[#050505] rounded-xl border border-zinc-800 p-8 flex flex-col md:flex-row gap-6 items-center md:items-start shadow-xl">
                ...
                <div>
                    <h3 className="text-2xl font-bold text-white mb-2 font-serif tracking-tight">Breakout AI Quant Team</h3>
                    <p className="text-zinc-400 leading-relaxed font-mono text-sm">
                        This institutional research is generated by the Breakout AI Engine. Our models continuously ingest SEC filings, monitor algorithmic order flow, and execute O'Neil's CAN SLIM breakout protocols to deliver emotionless, actionable insights for retail investors.
                    </p>
                </div>
            </section>
