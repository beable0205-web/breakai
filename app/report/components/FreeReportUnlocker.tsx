...
export default function FreeReportUnlocker({ reportId }: { reportId: string }) {
    ...
    return (
        <div className="mb-8 p-4 bg-emerald-900/20 border border-emerald-500/30 rounded-xl flex items-center gap-3">
            <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
            <p className="text-emerald-400 text-sm font-bold font-sans">
